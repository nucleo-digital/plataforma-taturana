...
Router.onBeforeAction(mustBeSignedIn, {only: ['ambassador', 'ambassador-edit', 'new-screening/:_id', 'edit-screening/:_id', 'report/:_id']});
Router.onBeforeAction(isAdmin, {only: ['adm', 'adm/films', 'adm/report/:_id', 'adm/film/:_id/reports', 'adm/session/:_id', 'adm/ambassador/:_id', 'adm/films/:_id/edit', 'adm/films' ]});
