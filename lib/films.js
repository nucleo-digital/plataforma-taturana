...
Films.disseminate = function() {
  return Films.find({
    $or: [{status:'Difusão'},{status:'Difusão/Portfolio'}]
  }).fetch();
}
Films.all = function(){
...
Films.inventory = function(film){
  console.log("filme tratado:" + film.title);
  console.log(film);
  console.log("dados do inventory:");
  console.log(FilmScreeningInventory[film.title]);
  var legacyData = FilmScreeningInventory[film.title]
  console.log("dados do inventory em uma variavel:");
